...
export FACILITY_BASE_URL INVENTORY_BASE_URL WES_BASE_URL FULFILLMENT_BASE_URL WORKFORCE_BASE_URL OPS_AGENT_BASE_URL ORDER_BASE_URL INVENTORY_DB_URL WES_DB_URL FULFILLMENT_DB_URL ORDER_DB_URL
